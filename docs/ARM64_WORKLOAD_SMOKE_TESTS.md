...
```text
26 / 26 passing
report: /workspace/tmp/ish-arm64-runtime-coverage-20260505-054944.md
```
...
report: /workspace/tmp/benchmarksgame-java-equivalent-smoke-20260505-055115.md
```
