...
- Runtime coverage: `/workspace/tmp/ish-arm64-runtime-coverage-20260513-212130.md`
  - Result: 49 / 49 passing
  - Includes no-safety-valve/no-NETDIAG Rust Cargo/std coverage, Erlang helper-thread cleanup validation, UDP/TCP socket-option and `sendmsg`/`recvmsg` ABI coverage, and Python/Lua/Java/Clojure/PyPy/Swift/Rust/Erlang/Zig smoke or availability coverage.
