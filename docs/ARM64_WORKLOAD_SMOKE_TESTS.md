...
```text
26 / 26 passing
report: /workspace/tmp/ish-arm64-runtime-coverage-20260505-072351.md
```
...
report: /workspace/tmp/benchmarksgame-java-equivalent-smoke-20260505-072530.md
```
